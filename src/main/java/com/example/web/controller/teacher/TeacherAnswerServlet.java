...
@WebServlet(name = "TeacherAnswerServlet", value = "/TeacherAnswer")
@MultipartConfig()
public class TeacherAnswerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ThymeleafUtil.getEngine().process("templates/teacherAnswer.html", context, resp.getWriter());
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (SqlSession sqlSession = MyBatisUtil.getFactory().openSession(true)){
            ...
            answerMapper.addAnswer(questionId,req.getParameter("answerContent"));
        ...
        resp.getWriter().print("<script language='javascript'>" +
                "alert('"+message+"');" +
                "window.location.href='TeacherCourseQuestion?courseid="+courseid+"';</script>");
    }
}
